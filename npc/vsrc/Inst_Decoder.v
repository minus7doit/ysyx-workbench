...
imm_mux (
    ...
    .key        (opcode),
    .default_out(32'b0 ),
    .lut({TYPE_U0,{12{inst[31:12],12'b0},,TYPE_U1,{inst[31:12],12'b0},TYPE_I0,{20{inst[31]},inst[31:20]},,TYPE_I1,,{20{inst[31]},inst[31:20]},TYPE_B,{20{inst[31]},inst[31],inst[7],inst[30:25],inst[1:8]},TYPE_J,{12{inst[31]},inst[31],inst[19:12],inst[20],inst[30:21],1'b0},TYPE_S,{20{inst[31]},inst[31:25],inst[11:7]}}));
//在这里对寄存器进行读？
