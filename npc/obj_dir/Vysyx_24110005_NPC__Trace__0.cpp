...
void Vysyx_24110005_NPC___024root__trace_chg_sub_0(Vysyx_24110005_NPC___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
                                  ...
                                  ? 1U : ((0xa3U == (IData)(vlSelf->ysyx_24110005_NPC__DOT__alu_ins__DOT__sel))
                                           ? 3U : (
                                                   (0x123U 
                                                    ...
                                                    ? 0xfU
                                                    : 0U)))),8);
        bufp->chgCData(oldp+24,(vlSelf->ysyx_24110005_NPC__DOT__alu_ins__DOT__op_lut
    ...
    bufp->chgIData(oldp+95,(vlSelf->exit_code),32);
    bufp->chgIData(oldp+96,((((0x63U == (0x7fU & vlSelf->ysyx_24110005_NPC__DOT__current_inst)) 
    ...
    bufp->chgIData(oldp+98,(((0U != (0x1fU & (vlSelf->ysyx_24110005_NPC__DOT__current_inst 
                                              >> 0x14U)))
                              ? vlSelf->ysyx_24110005_NPC__DOT__reg_rd__DOT__rf
                             [(0x1fU & (vlSelf->ysyx_24110005_NPC__DOT__current_inst 
                                        >> 0x14U))]
                              : 0U)),32);
    bufp->chgIData(oldp+99,(vlSelf->ysyx_24110005_NPC__DOT__reg_wdata),32);
    bufp->chgIData(oldp+100,(vlSelf->ysyx_24110005_NPC__DOT__alu_ins__DOT__mem_addr),32);
    bufp->chgIData(oldp+101,(vlSelf->ysyx_24110005_NPC__DOT__alu_ins__DOT__mem_rdata),32);
}
