    ...
    , TOP____024unit{this, Verilated::catName(namep, "$unit")}
{
    ...
    for (int __Vfinal = 0; __Vfinal < 2; ++__Vfinal) {
        __Vscope_ysyxSoCFull__asic__cpu__cpu.varInsert(__Vfinal,"debug_ifu_arready", &(TOP.ysyxSoCFull__DOT__asic__DOT__cpu__DOT__cpu__DOT__debug_ifu_arready), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RD,0);
    }
}
