...
VL_ATTR_COLD void Vysyx_24110005_NPC___024root__trace_init_sub__TOP__0(Vysyx_24110005_NPC___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+106,"exit_code", false,-1, 31,0);
    tracep->pushNamePrefix("ysyx_24110005_NPC ");
    tracep->declBit(c+104,"clk", false,-1);
    tracep->declBit(c+105,"rst", false,-1);
    tracep->declBus(c+106,"exit_code", false,-1, 31,0);
    tracep->declBus(c+109,"DATA_WIDTH", false,-1, 31,0);
    tracep->declBus(c+110,"OP_WIDTH", false,-1, 31,0);
    tracep->declBus(c+111,"REG_ADDR_WIDTH", false,-1, 31,0);
    tracep->declBus(c+112,"FUN_WIDTH", false,-1, 31,0);
    tracep->declBus(c+113,"BASE_ADDR", false,-1, 31,0);
    tracep->declBus(c+114,"MAX_INS", false,-1, 31,0);
    ...
    tracep->declBus(c+107,"reg_wdata", false,-1, 31,0);
    ...
    tracep->declBus(c+42,"fun", false,-1, 2,0);
    tracep->declBus(c+97,"dnpc", false,-1, 31,0);
    tracep->declBus(c+107,"w_data", false,-1, 31,0);
    tracep->declBit(c+52,"wen", false,-1);
    tracep->declBit(c+49,"w_finish_sim", false,-1);
    tracep->declBus(c+115,"src1_comp", false,-1, 31,0);
    tracep->declBus(c+116,"src2_comp", false,-1, 31,0);
    tracep->declBit(c+53,"mem_visit_valid", false,-1);
    tracep->declBus(c+117,"imm_comp", false,-1, 31,0);
    tracep->declBus(c+54,"snpc", false,-1, 31,0);
    tracep->declBus(c+100,"mem_addr", false,-1, 31,0);
    tracep->declBus(c+99,"mem_wdata", false,-1, 31,0);
    tracep->declBit(c+55,"mem_wen", false,-1);
    tracep->declBus(c+56,"wmask", false,-1, 7,0);
    tracep->declBus(c+108,"mem_rdata", false,-1, 31,0);
    tracep->declBus(c+118,"TYPE_I0", false,-1, 6,0);
    tracep->declBus(c+119,"TYPE_I1", false,-1, 6,0);
    tracep->declBus(c+120,"TYPE_I2", false,-1, 6,0);
    tracep->declBus(c+121,"TYPE_B", false,-1, 6,0);
    tracep->declBus(c+122,"TYPE_J", false,-1, 6,0);
    tracep->declBus(c+123,"TYPE_S", false,-1, 6,0);
    tracep->declBus(c+124,"TYPE_U0", false,-1, 6,0);
    tracep->declBus(c+125,"TYPE_U1", false,-1, 6,0);
    tracep->declBus(c+126,"TYPE_R", false,-1, 6,0);
    tracep->declBus(c+113,"BASE_ADDR", false,-1, 31,0);
    tracep->declBus(c+127,"ALL_1", false,-1, 31,0);
    tracep->declQuad(c+101,"signed_mulh__Vstatic__mul_result", false,-1, 63,0);
    tracep->declBus(c+103,"mulh", false,-1, 31,0);
    ...
    tracep->declBus(c+43,"opcode", false,-1, 6,0);
    tracep->declBus(c+44,"w_addr", false,-1, 4,0);
    tracep->declBus(c+128,"TYPE_NUM", false,-1, 31,0);
    tracep->declBus(c+110,"TYPE_WIDTH", false,-1, 31,0);
    tracep->declBus(c+118,"TYPE_I0", false,-1, 6,0);
    tracep->declBus(c+119,"TYPE_I1", false,-1, 6,0);
    tracep->declBus(c+129,"TYPE_I3", false,-1, 6,0);
    tracep->declBus(c+121,"TYPE_B", false,-1, 6,0);
    tracep->declBus(c+122,"TYPE_J", false,-1, 6,0);
    tracep->declBus(c+123,"TYPE_S", false,-1, 6,0);
    tracep->declBus(c+124,"TYPE_U0", false,-1, 6,0);
    ...
    tracep->declBus(c+110,"KEY_LEN", false,-1, 31,0);
    tracep->declBus(c+109,"DATA_LEN", false,-1, 31,0);
    tracep->declBus(c+47,"out", false,-1, 31,0);
    tracep->declBus(c+43,"key", false,-1, 6,0);
    tracep->declBus(c+130,"default_out", false,-1, 31,0);
    tracep->declArray(c+57,"lut", false,-1, 350,0);
    tracep->pushNamePrefix("i0 ");
    tracep->declBus(c+128,"NR_KEY", false,-1, 31,0);
    tracep->declBus(c+110,"KEY_LEN", false,-1, 31,0);
    tracep->declBus(c+109,"DATA_LEN", false,-1, 31,0);
    tracep->declBus(c+131,"HAS_DEFAULT", false,-1, 31,0);
    tracep->declBus(c+47,"out", false,-1, 31,0);
    tracep->declBus(c+43,"key", false,-1, 6,0);
    tracep->declBus(c+130,"default_out", false,-1, 31,0);
    tracep->declArray(c+57,"lut", false,-1, 350,0);
    tracep->declBus(c+132,"PAIR_LEN", false,-1, 31,0);
    for (int i = 0; i < 9; ++i) {
...
VL_ATTR_COLD void Vysyx_24110005_NPC___024root__trace_full_sub_0(Vysyx_24110005_NPC___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
                                           ...
                                           | ((0x6fU 
                                              ...
                                              & (0U 
                                                 ...
                                                 (0x1fU 
                                                  & (vlSelf->ysyx_24110005_NPC__DOT__current_inst 
                                                     >> 7U))))))))))));
    bufp->fullBit(oldp+53,(((3U == (0x7fU & vlSelf->ysyx_24110005_NPC__DOT__current_inst)) 
                            | (0x23U == (0x7fU & vlSelf->ysyx_24110005_NPC__DOT__current_inst)))));
    bufp->fullIData(oldp+54,(((IData)(4U) + vlSelf->ysyx_24110005_NPC__DOT__pc)),32);
    bufp->fullBit(oldp+55,((0x23U == (0x7fU & vlSelf->ysyx_24110005_NPC__DOT__current_inst))));
    bufp->fullCData(oldp+56,(((0x1000U & vlSelf->ysyx_24110005_NPC__DOT__current_inst)
                               ? 3U : ((0x2000U & vlSelf->ysyx_24110005_NPC__DOT__current_inst)
                                        ? 0xfU : 1U))),8);
    bufp->fullWData(oldp+57,(vlSelf->ysyx_24110005_NPC__DOT__ins_Decoder__DOT____Vcellinp__imm_mux__lut),351);
    bufp->fullQData(oldp+68,(vlSelf->ysyx_24110005_NPC__DOT__ins_Decoder__DOT__imm_mux__DOT__i0__DOT__pair_list[0]),39);
    bufp->fullQData(oldp+70,(vlSelf->ysyx_24110005_NPC__DOT__ins_Decoder__DOT__imm_mux__DOT__i0__DOT__pair_list[1]),39);
    bufp->fullQData(oldp+72,(vlSelf->ysyx_24110005_NPC__DOT__ins_Decoder__DOT__imm_mux__DOT__i0__DOT__pair_list[2]),39);
    bufp->fullQData(oldp+74,(vlSelf->ysyx_24110005_NPC__DOT__ins_Decoder__DOT__imm_mux__DOT__i0__DOT__pair_list[3]),39);
    bufp->fullQData(oldp+76,(vlSelf->ysyx_24110005_NPC__DOT__ins_Decoder__DOT__imm_mux__DOT__i0__DOT__pair_list[4]),39);
    bufp->fullQData(oldp+78,(vlSelf->ysyx_24110005_NPC__DOT__ins_Decoder__DOT__imm_mux__DOT__i0__DOT__pair_list[5]),39);
    bufp->fullQData(oldp+80,(vlSelf->ysyx_24110005_NPC__DOT__ins_Decoder__DOT__imm_mux__DOT__i0__DOT__pair_list[6]),39);
    bufp->fullQData(oldp+82,(vlSelf->ysyx_24110005_NPC__DOT__ins_Decoder__DOT__imm_mux__DOT__i0__DOT__pair_list[7]),39);
    bufp->fullQData(oldp+84,(vlSelf->ysyx_24110005_NPC__DOT__ins_Decoder__DOT__imm_mux__DOT__i0__DOT__pair_list[8]),39);
    bufp->fullIData(oldp+86,(vlSelf->ysyx_24110005_NPC__DOT__ins_Decoder__DOT__imm_mux__DOT__i0__DOT__data_list[0]),32);
    bufp->fullIData(oldp+87,(vlSelf->ysyx_24110005_NPC__DOT__ins_Decoder__DOT__imm_mux__DOT__i0__DOT__data_list[1]),32);
    bufp->fullIData(oldp+88,(vlSelf->ysyx_24110005_NPC__DOT__ins_Decoder__DOT__imm_mux__DOT__i0__DOT__data_list[2]),32);
    bufp->fullIData(oldp+89,(vlSelf->ysyx_24110005_NPC__DOT__ins_Decoder__DOT__imm_mux__DOT__i0__DOT__data_list[3]),32);
    bufp->fullIData(oldp+90,(vlSelf->ysyx_24110005_NPC__DOT__ins_Decoder__DOT__imm_mux__DOT__i0__DOT__data_list[4]),32);
    bufp->fullIData(oldp+91,(vlSelf->ysyx_24110005_NPC__DOT__ins_Decoder__DOT__imm_mux__DOT__i0__DOT__data_list[5]),32);
    bufp->fullIData(oldp+92,(vlSelf->ysyx_24110005_NPC__DOT__ins_Decoder__DOT__imm_mux__DOT__i0__DOT__data_list[6]),32);
    bufp->fullIData(oldp+93,(vlSelf->ysyx_24110005_NPC__DOT__ins_Decoder__DOT__imm_mux__DOT__i0__DOT__data_list[7]),32);
    bufp->fullIData(oldp+94,(vlSelf->ysyx_24110005_NPC__DOT__ins_Decoder__DOT__imm_mux__DOT__i0__DOT__data_list[8]),32);
    bufp->fullIData(oldp+95,(vlSelf->ysyx_24110005_NPC__DOT__ins_Decoder__DOT__imm_mux__DOT__i0__DOT__lut_out),32);
    bufp->fullBit(oldp+96,(vlSelf->ysyx_24110005_NPC__DOT__ins_Decoder__DOT__imm_mux__DOT__i0__DOT__hit));
    bufp->fullIData(oldp+97,(vlSelf->ysyx_24110005_NPC__DOT__dnpc),32);
    bufp->fullIData(oldp+98,(vlSelf->ysyx_24110005_NPC__DOT__src1),32);
    bufp->fullIData(oldp+99,(vlSelf->ysyx_24110005_NPC__DOT__alu_ins__DOT__mem_wdata),32);
    bufp->fullIData(oldp+100,(vlSelf->ysyx_24110005_NPC__DOT__alu_ins__DOT__mem_addr),32);
    bufp->fullQData(oldp+101,(vlSelf->ysyx_24110005_NPC__DOT__alu_ins__DOT__signed_mulh__Vstatic__mul_result),64);
    bufp->fullIData(oldp+103,(vlSelf->ysyx_24110005_NPC__DOT__alu_ins__DOT__mulh),32);
    bufp->fullBit(oldp+104,(vlSelf->clk));
    bufp->fullBit(oldp+105,(vlSelf->rst));
    bufp->fullIData(oldp+106,(vlSelf->exit_code),32);
    bufp->fullIData(oldp+107,(vlSelf->ysyx_24110005_NPC__DOT__reg_wdata),32);
    bufp->fullIData(oldp+108,(vlSelf->ysyx_24110005_NPC__DOT__alu_ins__DOT__mem_rdata),32);
    ...
    bufp->fullIData(oldp+115,(vlSelf->ysyx_24110005_NPC__DOT__alu_ins__DOT__src1_comp),32);
    bufp->fullIData(oldp+116,(vlSelf->ysyx_24110005_NPC__DOT__alu_ins__DOT__src2_comp),32);
    bufp->fullIData(oldp+117,(vlSelf->ysyx_24110005_NPC__DOT__alu_ins__DOT__imm_comp),32);
    bufp->fullCData(oldp+118,(3U),7);
    bufp->fullCData(oldp+119,(0x13U),7);
    bufp->fullCData(oldp+120,(0x67U),7);
    bufp->fullCData(oldp+121,(0x63U),7);
    bufp->fullCData(oldp+122,(0x6fU),7);
    bufp->fullCData(oldp+123,(0x23U),7);
    bufp->fullCData(oldp+124,(0x37U),7);
    bufp->fullCData(oldp+125,(0x17U),7);
    bufp->fullCData(oldp+126,(0x33U),7);
    bufp->fullIData(oldp+127,(1U),32);
    bufp->fullIData(oldp+128,(9U),32);
    bufp->fullCData(oldp+129,(0x73U),7);
    bufp->fullIData(oldp+130,(0U),32);
    bufp->fullIData(oldp+131,(1U),32);
    bufp->fullIData(oldp+132,(0x27U),32);
    bufp->fullIData(oldp+133,(9U),32);
}
